...
def main():
    print('{:-^60}'.format('Running sphere_molecule_stern test'))
    try:
    ...
    analytical = an_solution.an_P(numpy.array([1.]), numpy.array([[1.,1.,1.41421356]]), 4., 80., 4., 0.125, 5., 20)
