...
extern void directKt_sort(double *Ktx_aux, int Ktx_auxSize, double *Kty_aux, int Kty_auxSize, double *Ktz_aux, int Ktz_auxSize,
        ...
        double *m, int mSize, double *mKclean, int mKcleanSize,
        ...
        double *Xsk, int XskSize, double *Wsk, double kappa, int WskSize, double threshold, double eps, double *aux, int auxSize);
